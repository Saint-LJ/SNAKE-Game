...
class WorldModel {
    ...
    private collisionHandlers: ActorCollisionHandlers; // Fix
    ...
    /**
     * @note
     * experimental code, idk if this is solid
     */
    addFood(food: Food) {
    ...
    allFoods(): Food[] {
        ...
        this.actors.forEach((currentActor) => {
            if (currentActor.type === 'food') {
                foods.push(currentActor as Food);
            }
        });
